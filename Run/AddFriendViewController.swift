...
class AddFriendViewController: UIViewController, UISearchBarDelegate, UISearchDisplayDelegate, UITableViewDelegate {
    ...
    func searchBar(searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        self.userNameArray.removeAll()
            ...
            var runQuery:String = "http://192.168.1.133/userquery.php?namequery=" + "\(searchText)"
...
//    }
    ...
    func addFriend(sender: UIButton!) {
        ...
        let urlPath: String = "http://192.168.1.133/changefriend.php?friendstring=" + "\(newAddedWebString)" + "&userid=" + "\(userId!)" + "&verificationid=" + "\(verificationId!)"
        print(urlPath)
    ...
    func removeFriend(sender: UIButton!){
        ...
        let urlPath: String = "http://192.168.1.133/changefriend.php?friendstring=" + "\(newRemovedWebString)" + "&userid=" + "\(userId!)" + "&verificationid=" + "\(verificationId!)"
        print(urlPath)
        let url: NSURL = NSURL(string: urlPath)!
        let request: NSURLRequest = NSURLRequest(URL: url)
        let connection: NSURLConnection = NSURLConnection(request: request, delegate: self, startImmediately: true)!
